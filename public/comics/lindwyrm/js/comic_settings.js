...
// COMIC PAGE SETTINGS
const folder = "../../img/comics/lindwyrm"; //directory of the folder where you keep all the comics
...
const navFolder = "../../img/comics/comicnav"; //directory where nav images are stored
