...
function setHeight(e) {
  let container = document.querySelector(".illustrations-container");

  container.style.maxHeight = 

  console.log(container.offsetHeight);
  
  let newHeight = container.offsetHeight - 1000
  console.log(newHeight);
  
  let newHeightString = newHeight + "px"
  console.log(newHeightString);

  document.querySelector(".illustrations-container").style.maxHeight = newHeightString;
}
