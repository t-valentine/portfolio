...
document.querySelector(".writeHeader").innerHTML =
  `
    <header>
        ...
        <h1> <a href="` +
  relativePath +
  `/index.html" class="nameHeader"> &#10052 Tobi Valentine &#10052 </a> </h1>
        </div>
        <div class="nav">
          <a href="` +
  relativePath +
  `/comic-home.html" id="comics" class="unselected-page">Comics</a>
          <a href="` +
  relativePath +
  `/index.html" id="home" class="unselected-page">Illustrations</a>
          <a href="` +
  relativePath +
  `/about.html" id="about" class="unselected-page">About</a> 
        </div>
    </header>
`;
