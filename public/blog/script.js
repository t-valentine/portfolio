...
let postsArray = [
  ["posts/2025-12-31-2025-Reading.html"],
  ["posts/2025-07-01-2025-Reading-Summary-Pt1.html"],
  ["posts/2025-05-18-Why-Webp.html"],
  ["posts/2025-03-17-Cursed-Relics.html"],
  ["posts/2024-08-31-august-reading.html"],
  ["posts/2024-07-30-july-reading.html"],
  ["posts/2024-06-30-june-reading.html"],
  ["posts/2024-06-04-Tamagotchi-Uni-Guide.html"],
  ["posts/2024-05-29-Mid-2024-Planner-Roundup.html"],
  ["posts/2024-05-31-jan-to-may-reading.html"],
];
...
let recentPostListHTML = "<h2 id='recent'>Recent Posts</h2><ul>";
...
if (postsArray.length < 2) {
  nextprevHTML = '<a href="' + blogrelativePath + '/index.html">Home</a>';
...
let navDivs = document.querySelectorAll(".nextprev");
for (let i = 0; i < navDivs.length; i++) {
  navDivs[i].innerHTML = nextprevHTML;
}
...
if (document.getElementById("post-date")) {
  document.getElementById("post-date").innerHTML = niceDate;
}
